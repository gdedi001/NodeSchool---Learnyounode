...
var mymodule = require('./module6.js'); // import the module that we just created

var dirName = process.argv[2]; // obtain the directory name from provided array
var extension = process.argv[3]; // obtain intented file extension from provided array
